...
public class FloatingModMenuService extends Service {
    ...
    public void onCreate() {
        ...
        //Create the menu
        initFloating();
		overlayView = new ESP(getBaseContext());
		DrawCanvas();
    ...
    public static native void Espview(ESP espView, Canvas canvas);
